...
import '../models/audit_data_model.dart';
import 'moor_database/audit_tables_database.dart';
...
class AuditTableDataSourceImpl implements AuditTableDataSource {
  ...
  AuditTableDataSourceImpl(this.auditDatabase);

  @override
  Future<List<List<dynamic>>> getAllTablesRowCount() async {
    var result = await auditDatabase.getCountGeneral();
    final List<List<dynamic>> data = [
      ...
      ["auditEntityTypes", result.countAuditEntityTypess],
      ...
      ["auditGroups", result.countAuditGroupss]
    ];
    return data;
  }
  ...
  Future<void> addAllJsonDataIntoDb() async {
    ...
    final convertedToModel = AuditDataModel.fromJson(map);
